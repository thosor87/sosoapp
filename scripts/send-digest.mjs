...
console.log('EMAILJS_SERVICE_ID set:', !!EMAILJS_SERVICE_ID)
console.log('EMAILJS_TEMPLATE_ID set:', !!EMAILJS_TEMPLATE_ID)
console.log('EMAILJS_PUBLIC_KEY set:', !!EMAILJS_PUBLIC_KEY)
console.log('EMAILJS_PRIVATE_KEY set:', !!EMAILJS_PRIVATE_KEY)
const missing = [
